...
- [X] Clone this repo
- [X] Create a branch `git checkout -b 'Joseph-Graham'`
  -[X] Add a file to the project called `Joseph-Graham`.txt. This file can contain anything.
...
- [X] Go into your project folder, make a new branch `Joseph-Graham`
